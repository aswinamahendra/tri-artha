...
const About = () => {
  return (
    <section className="relative pt-[120px] pb-24" id="about">
      <div className="container mx-auto h-full">
        <div className="h-full flex items-center justify-center">
          ...
          >
            <div>
              <AnimatedText text="My Name is Rizqy" textStyles="h2 mb-2" />
              <p className="text-lg">Website Developer & Designer</p>
            </div>
            <p className="max-w-[680px] mx-0 xl:mx-0 mb-2 text-justify">
            ...
            {/* info items */}
            <div className="flex flex-col lg:flex-row gap-8 xl:gap-12 max-w-max mx-auto
            xl:mx-0 items-center">
              {/* item 1 */}
              <div className="max-w-max">
                <div className="uppercase font-bold text-primary">Age</div>
                <p className="truncate">27 Years</p>
              </div>
              {/* item 2 */}
              <div className="max-w-max">
                <div className="uppercase font-bold text-primary">Born in</div>
                <p className="truncate">Tangerang, Indonesia</p>
              </div>
              {/* item 3 */}
              <div className="max-w-max">
