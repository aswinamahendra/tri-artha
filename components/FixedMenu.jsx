...
const FixedMenu = () => {
  ...
  return (
    <div
      className="fixed w-full h-[400px] z-50 flex justify-center
      ...
      <AnimatePresence>
        {showMenu && showMenuButton && (
          <motion.div
            ...
            md:max-w-none h-[400px] bottom-[28rem] xl:bottom-[21.2rem] px-4 pointer-events-auto"
          >
            <div
              className="bg-white w-full h-full shadow-custom max-w-[1170px] mx-auto
            py-12 xl:py-12 px-12 xl:px-32 flex items-center gap-12 rounded-lg"
            >
              <Nav
                containerStyles="md:border-r border-secondary/20 md:pr-12 w-full md:w-auto
              ...
              <div className="hidden md:flex mx-auto">
                <div>
                  ...
                  w-[32px] h-[32px] text-primary flex items-center justify-center rounded-full"
                  />
                </div>
              </div>
            </div>
