...
const services = [
  ...
  },
  {
    ...
    title: "Logo Specialist",
    description: "Creating a brand and logo with unique and satisfy.",
  },
  {
  ...
  return (
    <section className="relative z-40">
      <div className="container mx-auto">
        <ul
          className="relative grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-[20px]
          ...
          {services.map((service, index) => {
            return (
              <li
                ...
                md:max-w-none rounded-lg hover:scale-110 transition duration-300"
              >
                <Image
                  src={service.icon}
                  width={48}
